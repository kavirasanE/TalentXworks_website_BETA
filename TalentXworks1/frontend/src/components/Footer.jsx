        ...
        <div className='flex flex-col lg:flex-row gap-5 justify-between items-start'>
            ...
            <div className='flex flex-col w-96'>
                ...
                <p className='font-medium text-sm pb-4'>Suspendisse sem neque, auctor a elementum ut, varius
                    ...
                    <p> <span><input placeholder=' your email address' className='bg-gray-100 p-1 px-4 rounded-full '/></span> <button className='bg-black text-white p-1 px-5 rounded-full'>Signup</button></p>
            </div>
        </div>
